            ...
            <div className='flex flex-col gap-4'>
              ...
              {intakeUrl && (
                <>
                  ...
                  <div className='flex gap-2.5 rounded-lg border border-amber-900/40 bg-amber-950/20 px-3 py-2.5'>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      width='14'
                      height='14'
                    ...
                    <p className='text-[12px] leading-relaxed text-amber-400/90'>
                      El cuestionario incluye una cláusula informando al paciente de que se
                      utilizan herramientas digitales de asistencia para elaborar su plan.
                      El paciente debe aceptarla para poder enviar el formulario.
                    </p>
                  </div>
