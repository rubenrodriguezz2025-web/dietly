...
// Primitivos compartidos del editor de días:
// iconos SVG, campos editables inline, modal de guardar como receta,
// fila de ingrediente y formulario para añadir ingrediente.
// Importados tanto por MealCard como por DayHeader y day-editor.

import { useEffect, useRef, useState, useTransition } from 'react';

import { useToast } from '@/components/ui/use-toast';
import type { Ingredient, Meal, RecipeIngredient } from '@/types/dietly';
...
export function RefreshIcon({ size = 10 }: { size?: number }) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width={size} height={size} viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2.5' strokeLinecap='round' strokeLinejoin='round' aria-hidden='true'>
...
export function SaveAsRecipeModal({
  meal,
  onClose,
}: {
  meal: Meal;
